...
public class FixtureFiles {
  ...
  public static final String TANKERKOENIG_JSON_RESPONSE_NEIGHBOURHOOD_MULTI_30STATIONS_HAPPY =
      TANKERKOENIG_NEIGHBOURHOOD_JSON_RESPONSE_DIR + "30HappyStations.json";

  public static final String TANKERKOENIG_JSON_RESPONSE_NEIGHBOURHOOD_MULTI_2INVALID_2VALID =
      TANKERKOENIG_NEIGHBOURHOOD_JSON_RESPONSE_DIR + "2validStations_2invalidStations.json";
