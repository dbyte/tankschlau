...
@Component
class PetrolTypeModel {

  private static final Logger LOGGER = Logger.getLogger(PetrolTypeModel.class.getName());

  private final UserPrefs userPrefs;

  @Autowired
  PetrolTypeModel(UserPrefs userPrefs) {
    this.userPrefs = userPrefs;
  }

  String readPreferredPetrolTypeName() {
    return userPrefs.readPreferredPetrolType().name();
  }

  void writeSelectionToUserPrefs(String petrolTypeString) {
